/* Import createSelector from reselect to make selection
 of different parts of the state fast efficient */
...
export const getLayoutOpenedBasketName = createSelector(getLayoutState, fromLayout.getOpenedBasketName);
